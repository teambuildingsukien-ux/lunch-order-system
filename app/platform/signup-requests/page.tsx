...
import { Search, Crown, TrendingUp, CheckCircle2, XCircle, Mail } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
            ...
            <div className="relative overflow-hidden border-b border-amber-500/20 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900">
                ...
                <div className="relative max-w-7xl mx-auto px-6 py-8">
                    ...
                    <p className="text-slate-400 ml-14">Xem và duyệt các yêu cầu đăng ký tenant mới</p>
                </div>
            </div>
